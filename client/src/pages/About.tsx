...
export default function About() {
  return (
    <div className="space-y-16 pb-24 max-w-4xl">
      {/* Header */}
      ...
      <section className="space-y-6 font-serif text-lg leading-relaxed text-muted-foreground">
        <p>
          <span className="text-foreground font-semibold">Peter Yuill</span> is a Canadian painter and geometric abstractionist whose documented practice (2018–2025) constitutes a rigorous, longitudinal investigation into the relationship between sacred mathematics, existential philosophy, and emotional authenticity. Over seven years, his work has evolved across nine distinct phases—from the monochromatic precision of early Hong Kong abstraction to the large-format somatic ink practice of the present—demonstrating an extraordinary commitment to both technical discipline and radical transparency.
        </p>
      </section>
      ...
      <section className="space-y-6">
        <h2 className="font-mono text-sm tracking-widest text-primary">THE ARC: FROM SACRED GEOMETRY TO SOMATIC EXPRESSION</h2>
        <div className="space-y-6 font-serif text-base leading-relaxed text-muted-foreground">
          <p>
      ...
      {/* Nomadic Crisis */}
      <section className="space-y-6">
        <h2 className="font-mono text-sm tracking-widest text-primary">NOMADIC CRISIS AND MAXIMUM OUTPUT (2021–2024)</h2>
        <div className="space-y-6 font-serif text-base leading-relaxed text-muted-foreground">
          <p>
      ...
      {/* East-West Lineage */}
      <section className="space-y-6">
        <h2 className="font-mono text-sm tracking-widest text-primary">EAST-WEST LINEAGE AND THE NEW ERA (2024–PRESENT)</h2>
        <div className="space-y-6 font-serif text-base leading-relaxed text-muted-foreground">
          <p>
      ...
      {/* Market Independence */}
      <section className="space-y-6">
        <h2 className="font-mono text-sm tracking-widest text-primary">MARKET INDEPENDENCE AND INSTITUTIONAL CREDIBILITY</h2>
        <div className="space-y-6 font-serif text-base leading-relaxed text-muted-foreground">
          <p>
      ...
      {/* The Archive */}
      <section className="space-y-6">
        <h2 className="font-mono text-sm tracking-widest text-primary">THE ARCHIVE AS SPIRITUAL PRACTICE</h2>
        <div className="space-y-6 font-serif text-base leading-relaxed text-muted-foreground">
          <p>
      ...
      {/* Core Tensions */}
      <section className="space-y-6">
        <h2 className="font-mono text-sm tracking-widest text-primary">CORE TENSIONS AND SIGNIFICANCE</h2>
        <div className="space-y-6 font-serif text-base leading-relaxed text-muted-foreground">
          <p>
      ...
      <section className="space-y-6">
        <h2 className="font-mono text-sm tracking-widest text-primary">PROFESSIONAL CREDENTIALS</h2>
        <div className="space-y-4 font-serif text-base leading-relaxed text-muted-foreground">
          <div>
            <h3 className="font-mono text-xs text-foreground mb-2">MAJOR EXHIBITIONS</h3>
            <p>
          ...
          <div>
            <h3 className="font-mono text-xs text-foreground mb-2">INSTITUTIONAL COMMISSIONS</h3>
            <p>
              Peninsula Hotels, Jones Lang LaSalle, Soho House, NUVA Luxury
            </p>
          </div>
          <div>
            <h3 className="font-mono text-xs text-foreground mb-2">ARCHIVE</h3>
            <p>
              Project 666, Neon Crucible (ongoing documentation system, 2025)
            </p>
          </div>
          <div>
            <h3 className="font-mono text-xs text-foreground mb-2">REPRESENTATION</h3>
            <p>
      ...
      <section className="grid md:grid-cols-2 gap-12">
        ...
        <div className="space-y-4">
          <h3 className="font-mono text-sm tracking-widest text-primary">INQUIRIES</h3>
          <div className="space-y-2 font-mono text-sm text-muted-foreground">
