...
export default function About() {
  return (
    <div className="space-y-10 sm:space-y-16 pb-16 sm:pb-24 max-w-4xl">
      {/* Header */}
      ...
      {/* Introduction */}
      <section className="space-y-4 sm:space-y-6 font-serif text-sm sm:text-lg leading-relaxed text-muted-foreground">
        <p>
