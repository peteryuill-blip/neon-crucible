...
export default function WorkDetail() {
  ...
  const { data: work, isLoading } = useQuery({ queryKey: [`/api/works/${slug}`] });
    ...
    <main className="min-h-screen bg-background text-white selection:bg-[#00FFCC]">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 p-8 lg:p-16 max-w-[1600px] mx-auto">
        ...
        <div className="lg:col-span-4 flex flex-col gap-10">
          ...
          <div className="mt-auto opacity-10 font-mono text-[8px] tracking-[0.5em] uppercase">// Access_Restricted: [Rating_Lock] [Labor_Lock] [Disposition_Lock]</div>
        </div>
      </section>
    </main>
  );
